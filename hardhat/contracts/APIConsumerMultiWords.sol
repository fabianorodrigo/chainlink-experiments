...
/**
 * @notice  we want the price of ETH against several currencies: BTC, USD, and EUR. Our contract will have to support receiving multiple responses.
 ...
 */
contract APIConsumerMultiWords is ChainlinkClient, ConfirmedOwner {
  ...
  constructor() ConfirmedOwner(msg.sender) {
     ...
     * @dev This is called by the oracle. recordChainlinkFulfillment must be used so
     * it can reverts if the sender is not the oracle of the request.
     */
